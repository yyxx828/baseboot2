 ...
 */
public class JscpHttpServletRequest implements HttpServletRequest {

    private HttpServletRequest request = null;

    private JscpInputStream input = null;

    public JscpHttpServletRequest(HttpServletRequest request){
    ...
    public ServletInputStream getInputStream() throws IOException {
        if(input == null){
            input = new JscpInputStream(request.getInputStream());
        }
        return input;
    }
    ...
    public synchronized String toString(String charsetName){
        if(input != null){
            return this.input.toString(charsetName);
        }else {
            return null;
        }
    }
